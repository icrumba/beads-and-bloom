...
- [x] 04-02-PLAN.md -- Order list with data table, filtering/search, one-tap status advance, order detail page, and customers page
...
| 4. Admin & Order Management | 2/3 | In progress | - |
